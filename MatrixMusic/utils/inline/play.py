...
def stream_markup_timer(_, chat_id, played, dur):
    ...
    buttons = [
            ...
            InlineKeyboardButton(text="𝑺𝑶𝑼𝑹𝑪𝑬 ", url=f"https://t.me/O_U_Q1"),
            InlineKeyboardButton(text="GROUB", url=f"https://t.me/O_U_Q1"),
        ],[
...
def stream_markup(_, chat_id):
    buttons = [
        [
            ...
            InlineKeyboardButton(text="𝑺𝑶𝑼𝑹𝑪𝑬 ", url=f"https://t.me/O_U_Q1"),
            InlineKeyboardButton(text="G𝚁𝙾𝚄𝙿", url=f"https://t.me/O_U_Q1"),
        ],[
            InlineKeyboardButton(text="𝟑 𝐓 𝐛", url=f"https://t.me/O_U_1S"),
        ],[
            InlineKeyboardButton(text="⚡اضف البوت الي مجموعتك او قناتك", url=f"https://t.me/{app.username}?startgroup=true")],
